...
const RuleModal = ({ open, closeModal }: RuleModalProps) => {
  return (
    <div className='flex'>
      <Modal
        open={open}
      ...
      >
        ...
        >
          <div className='flex justify-between items-center mb-5'>
            ...
            <button onClick={closeModal} className='px-2'>
              X
            </button>
          </div>

            <div className='text-lg my-3 font-semibold'>공유 모드 룰</div>
            ...
            <div className='text-lg my-3 font-semibold'>개인 모드 게임 룰</div>
            <ul className='text-sm leading-normal list-disc list-inside break-words'>
